<template>
  <div class="mx-auto mt-2 pt-4">
    <input class="w-3/4 rounded-lg w-2xl border-2 mx-24 px-12 py-4 border-orange-400" type="search" name="keywords"
      id="" placeholder="请输入要搜索的文章标题" v-model="keywords" @change="searchPostByTitle" />
  </div>
